				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h3 class="alt">Thinking about selling <span class="blackblock"> DAVID WAS HERE 5711 Greeley Place?</span> Let us help! Team Fast Agents is YOUR personal team of professionals who makes Real Estate <span class="blueblock">EASY</span> for <span class="greenblock">YOU.</span></h3>
							</header>
					...
					<section id="about" class="three">
						<div class="container">
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 5711 Greeley Place</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>1133 Tiegen Dr</strong></h3>
										<ul>
											<li>2 Bed - 1 Bath</li>
											<li>1,214 Sq Ft -  5,400 Lot</li>
											<li>List: 2/4/14 - Sold: 2/5/14</li>
											<li>List: $349,900 - SOLD $400,000</li>
										</ul>
									</article>
								</div>
								<div class="4u">
							...
							<br />
							<a href="http://maxebrdi.paragonrels.com/publink/default.aspx?GUID=aec55028-eab7-47de-9479-dcf287a93904&Report=Yes" class="image full"><img style="width: 100%;" src="images/compdata.jpg" /></a>
						</div>
					</section>
